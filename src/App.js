...
import ApplyForInvestmentPage from "./pages/ApplyForInvestmentPage";
...
import ConnectMyInstitutionPage from "./pages/ConnectMyInstitutionPage";
  ...
  return (
    <>
      <Routes>
        ...
        <Route
          path="/research-my-problem"
          element={<ResearchMyProblemPage />}
        />
        <Route path="/publication-request" element={<PublishAnArticlePage />} />
        <Route
          path="/apply-for-investment"
          element={<ApplyForInvestmentPage />}
        />
        <Route path="/be-a-researcher" element={<BeAResearcherPage />} />
        <Route
          path="/request-help-for-research"
          element={<ReqestHelpForResearchPage />}
        />
        <Route
          path="/apply-for-project-funding"
          element={<ApplyForProjectFundingPage />}
        />
        <Route
          path="/researcher-partner-requirement"
          element={<ResearcherPartnerRequirementPage />}
        />{" "}
        <Route
          path="/connect-my-institution"
          element={<ConnectMyInstitutionPage />}
        />
