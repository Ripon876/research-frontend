...
import "./ApplyForProjectFunding.css";

function ApplyForProjectFunding() {
	const initialData = {
		name: "",
		email: "",
		title: "",
			...
			<div className="registration-form my-5">
				...
				>
					<div className="d-flex justify-content-center align-items-baseline mb-4">
						<h4>Apply For Project Funding</h4>
					</div>
					...
					<div className="form-group">
						<label>Effect in the society / Changes it will bring</label>
						<textarea
							className="form-control"
							placeholder="effects"
							rows="3"
...
export default ApplyForProjectFunding;
